...
public class BuilderGenerator {
	...
	private Set<String> createBuilderClass(IType clazz, PrintWriter pw) throws JavaModelException {
		...
		Set<String> importClasses = createBuilderMethods(pw);
	...
	private void createFieldDeclarations(PrintWriter pw) throws JavaModelException {
		for (BuilderField field : data.getSelectedFields()) {
			pw.println("private " + BuilderFieldUtil.getType(field) + " " + BuilderFieldUtil.getName(field) + ";");
		}
	}
