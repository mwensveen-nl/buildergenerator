...
public class GeneratorData {
    ...
    public static final String PREVENT_NULL_VALUE_FOR_COLLECTOINS = "PreventNullValueForCollectoins";
    ...
    public GeneratorData() {
        ...
        options.add(new Option("Prevent null value for Collections", PREVENT_NULL_VALUE_FOR_COLLECTOINS));
